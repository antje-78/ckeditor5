...
import BorderWidthEditing from './border-width-editing';
import BorderWidthUi from './border-width-ui';
 ...
 */
export default class BorderWidth extends Plugin {
	/**
	 * @inheritDoc
	 */
	static get requires() {
		return [ BorderWidthEditing, BorderWidthUi ];
	}
