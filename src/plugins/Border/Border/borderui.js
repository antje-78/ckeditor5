...
import borderLeftTablerowIcon from './theme/icons/border-left-tablerow.svg';
import borderTopTablerow from './theme/icons/border-top-tablerow.svg';
import borderBottomTablerow from './theme/icons/border-bottom-tablerow.svg';
...
const icons = new Map( [
	...
	[ 'left-tablerow', borderLeftTablerowIcon ],
	[ 'top-tablerow', borderTopTablerow ],
	[ 'bottom-tablerow', borderBottomTablerow ],
] );
